...
namespace BulkyBookWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            //  (this dropdown for role (Admin or customer ))     ( step 1 ) to add forienKey
            public string? Role { get; set; }
            [ValidateNever]
            public IEnumerable<SelectListItem> RoleList { get; set; }


            // add all of those properties in register page
            [Required]
            ...
            public int? CompanyId { get; set; }     //( step 1 ) to add forienKey
            [ValidateNever]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //  we must write all properties here ( to send to database)
